	...
	public function add_new_user(){	
		...
		if($this->check_existing_username() != FALSE){
			if($this->register_user() != FALSE){
				...
				$message = $this->db->escape("Hi " . ucfirst($user['username']) . "<p>You can login and start creating heroes!</p><p>Remember, were always looking for feedback on how we can improve the site! <a href='docs.google.com/forms/d/1zKansQ13GHGvO9Pq6NBppFmz41FtlGqX0HVpqXbVO7k/edit?usp=sharing' target='_blank' >Click this link</a> for a short survey on to let me know what you want to get from this platform!</p><p>Thanks,</br><br>Alex<br><strong>Admin</strong></p>");
				$env = array($user['email'],'noreply@whowouldwin.io','Who Would Win','WWW - Account Info!',"",$message);
